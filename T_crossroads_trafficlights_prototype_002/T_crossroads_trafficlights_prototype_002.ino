...
void executter(){
    ...
    for (int i = 0; i < 3; i++) {//red LOW for lines 7-9
    ...
    timekiller(1000); //orange red phase
    ...
    for (int i = 0; i < 3; i++) {//red LOW for lines 1-6
    ...
    while(((wl[0] == 0) || (wl[0] == 4) || (wl[0] == 5) || (wl[0] == 6)) && ((wl[1] == 0) || (wl[1] == 4) || (wl[1] == 5) || (wl[1] == 6)) && ((wl[2] == 0) || (wl[2] == 4) || (wl[2] == 5) || (wl[2] == 6)) && (ret_comb[0] == 4) && (ret_comb[1] == 5) && (ret_comb[2] == 6)){
      timekiller(27); //trap phase for 4,5,6
  }
    ...
    for (int n = 0; n < 3; n++) {//green LOW and HIGH flash for lines 7-9
    ...
    timekiller(500); //part of orange phase
   ...
   for (int i = 0; i < 3; i++) { //delwl lines

      delwl(ret_comb[i]);
    }

    timekiller(3000); //red phase
}
